...
Public Class Form1
    ...
    Private Sub Truss_Calculator()
        ...
        'Calculats the reactions forces generated by each support structure 
    ...
    'Subroutine for adding a row to the datagridview
    ...
    Private Sub Nodes_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Nodes.CellContentClick
